...
const initialFrames: Frame[] = [
  {
    ...
    autoplayMode: "all",
    isHovered: false,
    url: "https://lumalabs.ai/work/1", // Add URL for each frame
  },
  {
    id: 2,
